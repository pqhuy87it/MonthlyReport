//
//  PromiseKitTayloSwiftSongDataProvider.swift
...
class PromiseKitTayloSwiftSongDataProvider {
    func loadSong() -> Promise<[SongModel]> {
        return Promise { complete, reject in
            let url = "https://itunes.apple.com/search?media=music&entity=song&term=TaylorSwift"
